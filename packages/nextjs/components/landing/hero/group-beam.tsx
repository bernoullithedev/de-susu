...
export function GroupBeam() {
  ...
  return (
    <div
      className="relative backdrop-blur-md  border rounded-(--radius) flex h-[300px] w-full items-center justify-center overflow-hidden p-10"
      ref={containerRef}
    >
...
const Icons = {
    user:()=><Image alt="user-profile" src={User} width={30} height={70}/>,
    man:()=><Image alt="man" src={Man} width={30} height={70}/>,
    man1:()=><Image alt="man1" src={Man1} width={30} height={70}/>,
    user2:()=><Image alt="user2" src={User2} width={30} height={70}/>,
    woman:()=><Image alt="woman" src={Woman} width={30} height={70}/>,
    woman1:()=><Image alt="woman1" src={Woman1} width={30} height={70}/>,
  notion: () => (
    <svg
      width="100"
      height="100"
